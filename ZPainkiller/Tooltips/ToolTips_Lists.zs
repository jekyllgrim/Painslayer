...
*	PKTLTP Text Item
*/
class ListMenuItemPKTLTPTextItem : ListMenuItemTextItem
{
	String mTooltip;
	Name cr_TipColor;
	
	ListMenuItemPKTLTPTextItem Init(ListMenuDescriptor desc, String text, String tooltip, Name tipColor, String hotkey, Name child, int param = 0)
	{
		mTooltip = tooltip;
...
*	PKTLTP Patch Item
*/
class ListMenuItemPKTLTPPatchItem : ListMenuItemPatchItem
{
	String mTooltip;
	Name cr_TipColor;
	
	ListMenuItemPKTLTPPatchItem Init(ListMenuDescriptor desc, TextureID patch, String tooltip, Name tipColor, String hotkey, Name child, int param = 0)
	{
		mTooltip = tooltip;
		cr_TipColor = tipColor;
...
class PKTLTPListMenu : ListMenu
{
	...
	PKTLTPListMenu Init(Menu parent, ListMenuDescriptor desc)
	{
		iSkipTime = 0;
	...
	override void Ticker()
	{
		...
		{
			if (mDesc.mItems[mDesc.mSelectedItem] is "ListMenuItemPKTLTPTextItem")
			{
				tt = StringTable.Localize(ListMenuItemPKTLTPTextItem(mDesc.mItems[mDesc.mSelectedItem]).mTooltip);
				cr = ListMenuItemPKTLTPTextItem(mDesc.mItems[mDesc.mSelectedItem]).cr_TipColor;
				bValidObject = true;
			}
			else if (mDesc.mItems[mDesc.mSelectedItem] is "ListMenuItemPKTLTPPatchItem")
			{
				tt = StringTable.Localize(ListMenuItemPKTLTPPatchItem(mDesc.mItems[mDesc.mSelectedItem]).mTooltip);
				cr = ListMenuItemPKTLTPPatchItem(mDesc.mItems[mDesc.mSelectedItem]).cr_TipColor;
				bValidObject = true;
			}
			else
				bValidObject = false;
